...
class BelegtProzentTest {
	...
	BelegtProzentChart chart = new BelegtProzentChart(controller.getParkhausFromController());
	...
	void test() {
		...
		chart.setParkhausFromBelegtProzentChart(controller.getParkhausFromController());
		chart.update();
